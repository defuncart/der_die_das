...
class HorizontalButton extends StatelessWidget {
  const HorizontalButton({super.key, required this.text, required this.onPressed});
  ...
  Widget build(BuildContext context) {
    return BasicButton(
      ...
      child: RoundedRectangle(
        ...
        child: Text(
          text,
          style: context.textTheme.headlineMedium?.copyWith(color: Theme.of(context).scaffoldBackgroundColor),
        ),
      ),
    );
  }
